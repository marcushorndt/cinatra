...
Forward attribution-record correction (the Truthful Attribution protocol §5) for the
...
out-of-band: issue #288 is closed manually with a link to this correction and to
