# The Truthful Attribution protocol — attribution-record correction for the cinatra enforce-bootstrap merge
...
spec (the Truthful Attribution protocol §1, "one assistant per line — no comma lists")
